        ...
        <main role="main" class="inner cover" id="inner-cover">
            <form class="form-signin">
                ...
                <div class="form-label-group">
                    <input type="" id="inputEmail" class="form-control" placeholder="Nome de Usuario" name="username" required
                           autofocus>
                ...
                <button class="btn btn-lg btn-primary btn-block" type="submit" name="command" value="Login">Entrar</button>
            </form>
        </main>
    </form>
