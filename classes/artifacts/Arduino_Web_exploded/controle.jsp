            ...
            <div class="row">
                <div class="col-md-12 pull-right">
                    <ul class="teste" id="teste">
                        <li><a href="home.html" class="btn btn-default navbar-brand d-flex align-items-center"><strong>Home</strong></a>
                        </li>
                        ...
                        <li><a href="#" class="btn btn-default navbar-brand d-flex align-items-center"
                            ...
                            <ul id="consumoteste1">
                                <li><a href="index2.jsp" class="btn btn-default navbar-brand d-flex align-items-center"><strong>Di&aacute;rio</strong></a>
                                </li>
                                ...
                                <div class="container">
                                    <div class="col-md-12">
                                        <button id="QuartoOn" class="btn btn-outline-success"
                                                type="submit" name="command" value="ControleQuartoON" autocomplete="off"
                                                checked>Ligar
                                        </button>
                                        <button id="QuartoOff"
                                                class="btn btn-outline-danger btn-pull" type="submit" name="command"
                                                value="ControleQuartoOFF" autocomplete="off" disabled="true">Desligar
                                        </button>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="container">
                                    <div class="col-md-12">
                                        <button id="SalaOn" class="btn btn-outline-success"
                                                type="submit" name="command" value="ControleSalaON" autocomplete="off"
                                                checked>Ligar
                                        </button>
                                        <button id="SalaOff" class="btn btn-outline-danger btn-pull"
                                                type="submit" name="command" value="ControleSalaOFF" autocomplete="off">
                                            Desligar
                                        </button>
                                    </div>
                                </div>
